...
class MainActivity : AppCompatActivity() {
    ...
    private fun sendRequestCategory() {
        ...
        stringRequest2 =
            StringRequest(Request.Method.GET, "https://moviesapi.ir/api/v1/genres", { response ->
                val gson = Gson()
                load2!!.visibility = View.GONE
                val categoryItems = gson.fromJson<ArrayList<GenresItem>>(
                    response,
    ...
    private val sliderRunnable = Runnable {
        ...
        val itemCount = Objects.requireNonNull(
            viewPager!!.adapter
        ).itemCount
